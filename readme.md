...
readme.md
finalData.csv- tidy data set csv
finalData.txt- tidy data set txt
codebook.pdf- explains all the variables ithe tidy data sets 
run_analysis.R- script for modifying the data

This readme is a description of the run_analysis.R script in this repo. The steps followed in run_analysis.R are described below:
